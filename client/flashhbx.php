...
<button ngsf-toggle-fullscreen="" class="client__fullscreen" onclick="toggleFullScreen()" style="height: 30px;width: 33px;"><i show-if-fullscreen="true" class="client__fullscreen__icon icon icon--fullscreen"></i> <i show-if-fullscreen="true" class="client__fullscreen__icon icon icon--fullscreen-back ng-hide"></i></button>
	...
	<link rel="icon" href="">
		<link rel="stylesheet" type="text/css" href="https://habbex.org/client/loadhbx22222.css">
...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
	...
	<script type="text/javascript">
        ...
        swfobject.embedSWF('https://habbex.org/swf/gordon/HABBEX-PRODUCTION/Habbo.swf?s3sd', 'flash-container', '100%', '100%', '11.1.0', 'https://habbex.org/swf/gordon/PRODUCTION-201608171204-891546786/expressInstall.swf', flashvars, params, null, null);
